...
\documentclass[unicode,hyperfootnotes=false,xetex,colorlinks=true,nofonts,nobib]{tufte-handout} % use larger type; default would be 10pt
...
\begin{abstract}
  This document provides a step-by-step instruction in the preparation
  of a Finale Document for a finger-style guitar score. These
  instructions are specific to Finale 25 for MacOS and Windows 10.

\end{abstract}

\section{Introduction}
The purpose of this document is essentially to prevent bugs in the
Finale software. This is done by completely preparing the document
before any notes are placed. By completely preparing the document in
this manner, one will be able to proceed with the completion of a
Finale document with confidence that the program will \emph{most
  likely} and \emph{hopefully} not introduce any catastrophic
bugs. Some aspects of this document will shift and adapt with time and
experience.
